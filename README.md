...
| `maxBlockingTime`                | `number` | **Optional**. Time in milliseconds, after which the next iteration is called using asynchronously (as a macrotask). Defaults to `16`, which corresponds to roughly 60 fps.                |
